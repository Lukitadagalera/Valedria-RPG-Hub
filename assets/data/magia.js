...
window.GRIMORIO = [
  {
    escola: "Água", img: "assets/img/magia/escola-agua.png.webp",
    magias: [
  ...
  {
    escola: "Terra", img: "assets/img/magia/escola-terra.png.webp",
    magias: [
  ...
  {
    escola: "Fogo", img: "assets/img/magia/escola-fogo.png.webp",
    magias: [
      ...
      { grau: "Mago", nome: "Lança Ígnea", custo: "16 Mana", alcance: "médio", efeito: "1d20 + Sabedoria contra Defesa; dano 1d10+2 de fogo, ignorando metade de qualquer resistência a fogo." },
  ...
  {
    escola: "Ar", img: "assets/img/magia/escola-ar.png.webp",
    magias: [
  ...
  {
    escola: "Espacial", img: "assets/img/magia/escola-espacial.png.webp",
    magias: [
  ...
  {
    escola: "Barreiras", img: "assets/img/magia/escola-barreiras.png.webp",
    magias: [
  ...
  {
    escola: "Cura", img: "assets/img/magia/escola-cura.png.webp",
    magias: [
