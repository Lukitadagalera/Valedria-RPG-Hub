...
window.GUILDA_RECOMPENSA = "Recompensas monetárias em Coroas de cobre (CC), prata (CP) ou ouro (CO): 100 CC = 1 CP e 100 CP = 1 CO. Valores brutos por aventureiro, salvo indicação expressa. A guilda retém 10%: converta o total para cobre e arredonde a taxa uma única vez para CC inteiras, com metade para cima. Benefícios não monetários ficam fora da taxa. Alimentação e transporte devem constar do contrato. Prata, Ouro e Coroa também são nomes de patentes, distintos da moeda. Missões fracassadas não geram recompensa nem taxa. Nos territórios de outros povos, registre a contrapartida local acordada.";
...
window.MISSOES = [
  {
    ...
    "regiao": "Amieiro",
    "nivel": "Iniciante",
    "recompensa": "80 CC por aventureiro, pagos pelo chefe de vila",
  ...
  },
  {
    ...
    "regiao": "Amieiro",
    "nivel": "Iniciante",
    "recompensa": "1 CP e 20 CC por aventureiro + 10% do valor da carga recuperada para dividir entre o grupo",
  ...
  },
  {
    ...
    "regiao": "Amieiro",
    "nivel": "Iniciante",
    "recompensa": "1 CP por aventureiro, pagos pelo sacerdote local",
  ...
  },
  {
    ...
    "recompensa": "2 CP por aventureiro + isenção de pedágio por um mês",
  ...
  },
  {
    ...
    "regiao": "Ponte Alta",
    "nivel": "Iniciante a intermediário",
    "recompensa": "1 CP e 20 CC por aventureiro + desconto em serviços de forja",
  ...
  },
  {
    ...
    "regiao": "Ponte Alta",
    "nivel": "Iniciante a intermediário",
    "recompensa": "1 CP e 50 CC por aventureiro + gratidão pública",
  ...
  },
  {
    ...
    "nivel": "Regional",
    "recompensa": "3 CP por aventureiro e trecho seguro",
  ...
  },
  {
    ...
    "nivel": "Regional",
    "recompensa": "5 CP por aventureiro + equipamento militar básico",
  ...
  },
  {
    ...
    "regiao": "Feira Nova",
    "nivel": "Regional",
    "recompensa": "2 CP e 50 CC por aventureiro + item recuperado acordado em contrato",
  ...
  },
  {
    ...
    "nivel": "Intermediário",
    "recompensa": "7 CP por aventureiro + acesso temporário à biblioteca da Academia",
  ...
  },
  {
    ...
    "regiao": "Academia de Valédria",
    "nivel": "Intermediário",
    "recompensa": "5 CP por aventureiro, pagos discretamente",
  ...
  },
  {
    ...
    "regiao": "Montegris",
    "nivel": "Intermediário",
    "recompensa": "6 CP por aventureiro + favor comercial com Ostenfeld",
  ...
  },
  {
    ...
    "regiao": "Pedrafria",
    "nivel": "Intermediário",
    "recompensa": "7 CP e 50 CC por aventureiro + minério bruto",
  ...
  },
  {
    ...
    "nivel": "Intermediário",
    "recompensa": "9 CP por aventureiro",
  ...
  },
  {
    ...
    "recompensa": "12 CP por aventureiro + reputação com uma facção à escolha",
  ...
  },
  {
    ...
    "regiao": "Encruzilhada",
    "nivel": "Intermediário a avançado",
    "recompensa": "10 CP por aventureiro + acesso a mercador exótico",
  ...
  },
  {
    ...
    "regiao": "Encruzilhada",
    "nivel": "Intermediário a avançado",
    "recompensa": "15 CP por aventureiro",
  ...
  },
  {
    ...
    "recompensa": "30 CP por aventureiro + informação sobre a Transformação de Linhagem",
