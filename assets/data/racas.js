...
window.CASTAS_HUMANAS = [
  {
    ...
    img: "assets/img/racas/casta-plebeus.png.webp"
  },
  {
  ...
  },
  {
    ...
    img: "assets/img/racas/casta-alta-nobreza.png.webp"
  }
];
...
window.ELFOS = [
  {
    ...
    img: "assets/img/racas/elfos-da-floresta.png.webp"
  },
  {
    nome: "Elfos Negros",
    ...
    img: "assets/img/racas/elfos-negros.png.webp"
  },
  {
    ...
    img: "assets/img/racas/elfos-costeiros.png.webp"
  }
];
...
window.ANOES = {
  ...
  img: "assets/img/racas/anoes.png.webp",
  clas: [
    ...
    { nome: "Clã Pedra-Funda", descricao: "Focado em construção, arquitetura e engenharia de túneis, responsável por algumas das fortalezas mais duradouras do mundo anão. Vê o Clã Ferro-Fundo com desconfiança, mas mantém aliança estreita e histórica com o Clã Chama-Antiga.", img: "assets/img/racas/anoes.png.webp" },
    { nome: "Clã Chama-Antiga", descricao: "Guardião de forjas rituais e tradições de fé ligadas ao fogo sagrado das profundezas. Considerado o clã mais espiritual, frequentemente mediando disputas entre outros clãs quando a tradição exige um árbitro neutro.", img: "assets/img/racas/anoes.png.webp" },
    { nome: "Clã Veio-Negro", descricao: "Especializado em mineração de materiais raros e comércio com regiões demoníacas próximas às montanhas. Visto com certa suspeita pelos demais clãs por seus negócios discretos, mas tolerado por sua riqueza e utilidade comercial.", img: "assets/img/racas/anoes.png.webp" }
  ]
};
  ...
  subracas: [
    {
      ...
      img: "assets/img/racas/orcs-das-planicies.png.webp"
    },
    {
      ...
      img: "assets/img/racas/goblins-das-minas.png.webp"
    },
    {
      ...
      img: "assets/img/racas/demonios-do-mar-profundo.png.webp"
    },
    {
      ...
      img: "assets/img/racas/naga-demonios-do-deserto.png.webp"
    },
    {
      ...
      img: "assets/img/racas/demonios-das-montanhas-vermelhas.png.webp"
    }
  ]
};
