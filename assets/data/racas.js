...
window.CASTAS_HUMANAS = [
  {
    ...
    img: "assets/img/racas/casta-plebeus.webp"
  },
  {
    ...
    img: "assets/img/racas/casta-artesaos.webp"
  },
  {
    ...
    img: "assets/img/racas/casta-nobreza-menor.webp"
  },
  {
    ...
    img: "assets/img/racas/casta-alta-nobreza.webp"
  }
];
...
window.HUMANOS = {
  ...
  img: "assets/img/racas/humanos.webp"
};
...
window.ELFOS = [
  {
    ...
    img: "assets/img/racas/elfos-da-floresta.webp"
  },
  {
    nome: "Elfos Negros",
    ...
    img: "assets/img/racas/elfos-negros.webp"
  },
  {
    ...
    img: "assets/img/racas/elfos-costeiros.webp"
  }
];
...
window.ANOES = {
  ...
  img: "assets/img/racas/anoes.webp",
  clas: [
    ...
    { nome: "Clã Pedra-Funda", descricao: "Focado em construção, arquitetura e engenharia de túneis, responsável por algumas das fortalezas mais duradouras do mundo anão. Vê o Clã Ferro-Fundo com desconfiança, mas mantém aliança estreita e histórica com o Clã Chama-Antiga.", img: "assets/img/racas/anoes.webp" },
    { nome: "Clã Chama-Antiga", descricao: "Guardião de forjas rituais e tradições de fé ligadas ao fogo sagrado das profundezas. Considerado o clã mais espiritual, frequentemente mediando disputas entre outros clãs quando a tradição exige um árbitro neutro.", img: "assets/img/racas/anoes.webp" },
    { nome: "Clã Veio-Negro", descricao: "Especializado em mineração de materiais raros e comércio com regiões demoníacas próximas às montanhas. Visto com certa suspeita pelos demais clãs por seus negócios discretos, mas tolerado por sua riqueza e utilidade comercial.", img: "assets/img/racas/anoes.webp" }
  ]
};
  ...
  subracas: [
    {
      ...
      img: "assets/img/racas/orcs-das-planicies.webp"
    },
    {
      ...
      img: "assets/img/racas/goblins-das-minas.webp"
    },
    {
      ...
      img: "assets/img/racas/demonios-do-mar-profundo.webp"
    },
    {
      ...
      img: "assets/img/racas/naga-demonios-do-deserto.webp"
    },
    {
      ...
      img: "assets/img/racas/demonios-das-montanhas-vermelhas.webp"
    }
  ]
};
