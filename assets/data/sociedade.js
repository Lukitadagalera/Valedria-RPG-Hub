...
window.FACCOES_NPCS = [
  ...
  { grupo: "Religião e magia", nome: "Solares, a Luz", papel: "Figura de grande presença associada à proteção, à esperança e ao uso disciplinado da magia luminosa. É recebida com respeito em templos e círculos arcanos, sendo procurada quando um acontecimento sobrenatural exige não apenas poder, mas autoridade moral para reunir pessoas de facções diferentes.", img: "assets/img/sociedade/solares-a-luz.png" },

  { grupo: "Encruzilhada", nome: "Velho Aerith", papel: "Representante élfico no conselho de Encruzilhada, atua como voz moderada entre as facções, frequentemente mediando disputas antes que cheguem a conflito aberto.", img: "assets/img/sociedade/npc-velho-aerith.png" },
