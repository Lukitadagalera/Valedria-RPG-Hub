...
window.FACCOES_NPCS = [
  { grupo: "Amieiro", nome: "Mara, a Porta-voz", papel: "Espécie de prefeita informal de Amieiro, responsável por mediar disputas locais, receber viajantes e representar a vila diante de autoridades de Ponte Alta ou Portovale. Figura de confiança e ponto de contato natural para qualquer grupo que chegue à vila.", img: "assets/img/sociedade/npc-mara.jpg" },
  { grupo: "Amieiro", nome: "Irmã Iria", papel: "Cuida da pequena igreja e do orfanato de Amieiro, acolhendo crianças sem família e órfãos de viajantes. Figura religiosa respeitada na vila, próxima o suficiente das pessoas para saber os segredos e aflições de cada família.", img: "assets/img/sociedade/npc-iria.jpg" },
  { grupo: "Amieiro", nome: "Doran", papel: "Morador mais velho de Amieiro, auxilia a Irmã Iria com o orfanato e as tarefas da igreja. Conhece a vila há décadas e costuma ser a primeira pessoa a notar quando algo muda por ali.", img: "assets/img/sociedade/npc-doran.jpg" },
  { grupo: "Amieiro", nome: "Fazendeira de Amieiro", papel: "Responsável por boa parte da produção agrícola que sustenta a vila, cuidando de campos de trigo e criação de pequenos animais. Conhece bem as terras ao redor e os ciclos de plantio da região.", img: "assets/img/sociedade/npc-fazendeira-amieiro.jpg" },
  { grupo: "Amieiro", nome: "Artesã de Amieiro", papel: "Pequena artesã local, produz utensílios simples, tecidos e reparos gerais para os moradores da vila. Trabalho modesto, mas essencial para o cotidiano de Amieiro.", img: "assets/img/sociedade/npc-artesa-amieiro.jpg" },
  { grupo: "Amieiro", nome: "Mercador de Amieiro", papel: "Vive em Amieiro, mas passa boa parte do tempo viajando entre vilas próximas, comprando e revendendo mercadorias. Uma das poucas pessoas da vila com contato regular com o mundo fora dela.", img: "assets/img/sociedade/npc-mercador-amieiro.jpg" },
